...
const Home: NextPage = () => {
  return (
    ...
    <Head>
      ...
      <meta name="Client-Powered SaaS Solution" content="Simplify Your Workflow with Client-Powered: Automate Notifications, Sync with QuikBooks, and Boost Client Satisfaction." />
    ...
    <div className="container mx-auto px-8 flex-grow grid place-items-center -mb-64 pt-64">
      <div className="grid grid-rows-2 grid-cols-1 sm:grid-cols-2 gap-8 items-center justify-center">
        <div className="w-full space-y-6 z-40">
          ...
          <h2 className="md:text-2xl font-bold md:font-black mt-4 text-black">
    ...
    <h3 className="text-2xl md:text-4xl text-[#3e50c9] text-center py-16 tracking-wider bg-blue-100">Our client-powered SaaS solution automates notifications and integrates with QuikBooks API, so you can focus on growing your business.</h3>
    <div className="container mx-auto px-8 py-16">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:space-x-8">
        <div className="w-full lg:w-1/2 bg-pink-100 rounded-3xl p-8"> 
          <h4 className="text-4xl md:text-6xl font-black mt-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 pb-4">Features</h4>
          <ul className="list-disc list-inside mt-4 space-y-4 text-black text-left">
            <li className='text-xl md:text-2xl font-semibold '>Automate client notifications.</li>
            <li className='text-xl md:text-2xl font-semibold '>Sync data seamlessly with QuikBooks API.</li>
            <li className='text-xl md:text-2xl font-semibold '>Customizable to fit your business needs.</li>
            <li className='text-xl md:text-2xl font-semibold '>Accessible from anywhere, anytime using the cloud-based platform.</li>
            <li className='text-xl md:text-2xl font-semibold '>Improve workflow efficiency and save time and resources.</li>
            <li className='text-xl md:text-2xl font-semibold '>Increase client satisfaction with timely and accurate communication.</li>
          </ul>
        </div>
    ...
    <div className="container mx-auto px-8 z-10 flex-grow">
      <h2 className="text-3xl md:text-5xl font-black text-indigo-800 bg-indigo-100 rounded text-center mb-8 py-16 lg:mb-16">What Our Clients Are Saying</h2>
